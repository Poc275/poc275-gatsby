...
> <br />
> <cite>Mark &mdash; Shrooming (series 3, episode 3)</cite>
...
> <FontAwesomeIcon icon={faQuoteLeft} /> I got something up on my visual display unit this morning, Mark. I thought it was a high-definition photo of some dog s***. Then 
> I took a closer look, and I realised it was actually your sales record.
> <br />
> <cite>Johnson &mdash; The William Morris Years (series 9, episode 1)</cite>
...
> <FontAwesomeIcon icon={faQuoteLeft} /> Looks like I've got a job interview lined up, bathroom supplies. Incredibly flat management structure, which is cool.
> <br />
> <cite>Mark &mdash; Jeremy Therapised (series 8, episode 1)</cite>
...
> <FontAwesomeIcon icon={faQuoteLeft} /> Conversation is rubbish. You could literally waste years talking to someone and never get the bottom line.
> <br />
> <cite>Mark &mdash; Dance Class (series 2, episode 1)</cite>
...
> <FontAwesomeIcon icon={faQuoteLeft} /> Aww, we do love each other really.

<blockquote className="quote-response"><FontAwesomeIcon icon={faQuoteLeft} /> I simply must get rid of him.</blockquote>

<cite>Jeremy & Mark &mdash; Are We Going to Be Alright? (series 9, episode 6)</cite>
...
> <FontAwesomeIcon icon={faQuoteLeft} /> Not even sure where you'd sign it. Is that meant to be a dotted line? Who drew this up? A lot of these aren't proper sentences.
> <br />
> <cite>Mark &mdash; Spin War (series 5, episode 2)</cite>
...
> <FontAwesomeIcon icon={faQuoteLeft} /> You'll say anything won't you? Words don't mean a thing to you do they?
> <br />
> <cite>Mark &mdash; Sistering (series 3, episode 4)</cite>
...
> <FontAwesomeIcon icon={faQuoteLeft} /> He's an alpha male, Jeremy, and you'd be the first to admit you're a bottom-feeder.
> <br />
> <cite>Big Suze &mdash; Conference (series 4, episode 2)</cite>
...
> <FontAwesomeIcon icon={faQuoteLeft} /> Oh God, this is terrifying. Just me and the public and some laminated menus for protection.
> <br />
> <cite>Mark &mdash; The Affair (series 6, episode 4)</cite>
...
> <FontAwesomeIcon icon={faQuoteLeft} /> Yeah, OK, off to the toilet, have a wee and then back in. I could walk quicker, but it's interesting to note that I'm not. I'm walking at what I would describe in court as a normal pace, but which I think is actually slightly slower than normal. There's the toilet. Hmm, why didn't I go in? Here I go, into here. OK, this is interesting, where am I going now?
> <br />
> <cite>Mark &mdash; St Hospitals (series 7, episode 1)</cite>
...
> <FontAwesomeIcon icon={faQuoteLeft} /> Look, dude, Zahra's gonna call back. But, you know, until she does, we're in the Nether Zone, yeah? Time moves at a different speed in the Nether Zone.
> <br />
> <cite>Jeremy &mdash; St Hospitals (series 7, episode 4)</cite>
...
> <FontAwesomeIcon icon={faQuoteLeft} /> Oh, great, that's brilliant. F*** the agreement. F*** the Geneva Convention. F*** Parliamentary democracy. F*** everything. Is that your great new idea?
> <br />
> <cite>Mark &mdash; Quantocking II (series 8, episode 6)</cite>
