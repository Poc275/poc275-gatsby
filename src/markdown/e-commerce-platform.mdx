...
> <FontAwesomeIcon icon={faQuoteLeft} /> Fundamentally the UI and back-end are tightly coupled in a WordPress/WooCommerce setup, small changes are OK but anything more substantial opens up a world of pain.
