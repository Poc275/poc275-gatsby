...
Now all of this isn't to say a more talented developer could make this work. I hadn't used PHP for many a year and WordPress/WooCommerce *ain't me specialties*. It reached decision time, either I quit whilst I'm behind and see if we can hand off to a professional WordPress developer, or move on to Plan B.
